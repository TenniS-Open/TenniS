...
namespace ts {
    ...
    public:
        ...
        T &operator[](size_t i) { return this->m_data[i]; }

        const T &operator[](size_t i) const { return this->m_data[i]; }

        T &data(size_t n) { return this->m_data[n]; }

        const T &data(size_t n) const { return this->m_data[n]; }
    ...
    public:
        ...
        T &data(size_t m, size_t n) { return this->data(m * N + n); }

        const T &data(size_t m, size_t n) const { return this->data(m * N + n); }
    };
