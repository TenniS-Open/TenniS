...
#ifndef TENSORSTACK_BACKEND_BASE_CHANNEL_WISE_REDUCE_H
#define TENSORSTACK_BACKEND_BASE_CHANNEL_WISE_REDUCE_H
...
#endif //TENSORSTACK_BACKEND_BASE_CHANNEL_WISE_REDUCE_H
