...
namespace ts {
    ...
    template<>
    struct type<INT8> {
        using declare = int8_t;
    };
    template<>
    struct type<UINT8> {
        using declare = uint8_t;
    };
    template<>
    struct type<INT16> {
        using declare = int16_t;
    };
    template<>
    struct type<UINT16> {
        using declare = uint16_t;
    };
    template<>
    struct type<INT32> {
        using declare = int32_t;
    };
    template<>
    struct type<UINT32> {
        using declare = uint32_t;
    };
    template<>
    struct type<INT64> {
        using declare = int64_t;
    };
    template<>
    struct type<UINT64> {
        using declare = uint64_t;
    };
    template<>
    struct type<FLOAT16> {
        using declare = uint16_t;
    }; ///< not specific doing method
    template<>
    struct type<FLOAT32> {
        using declare = float;
    };
