...
namespace ts {
    namespace xnn {
        ...
        void Pooling2DV2::init() {
            ...
            m_op_pooling2d = OperatorCreator::Create(context.computing_device.type(), "xnn::pooling2d", false);
...
using namespace ts;
using namespace xnn;
TS_REGISTER_OPERATOR(Pooling2DV2, ts::XNNPACK, "xnn::pooling2d_v2")
