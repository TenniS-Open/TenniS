...
namespace ts {
    namespace xnn {
        ...
        void Pooling2DAutoPad::init() {
            ...
            // IS NHWC format
            this->static_padding.top = static_padding.data<int32_t>()[0];
            this->static_padding.bottom = static_padding.data<int32_t>()[1];
            this->static_padding.left = static_padding.data<int32_t>()[2];
            this->static_padding.right = static_padding.data<int32_t>()[3];
        }
...
using namespace ts;
using namespace ts::xnn;

TS_REGISTER_OPERATOR(Pooling2DAutoPad, XNNPACK, "xnn::_onnx_pooling2d_padding")
