...
#ifndef TENNIS_SIGMOID_H
#define TENNIS_SIGMOID_H
...
namespace ts {
    namespace xnn {
        class Sigmoid : public cpu::OperatorOnCPU<OperatorOnDevice> {
        public:
            using self = Sigmoid;
            ...
            void sigmoid(const Tensor &x, Tensor &out);
        private:
            xnn_status m_status;
