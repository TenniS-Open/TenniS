...
int Mul::to_index(const HypeShape &hype, const Shape & shape, const Shape &curshape) {
...
template<typename T>
void Mul::compute_run(const Tensor &input_tensor, const Tensor &right_tensor, Tensor *left_tensor) {
