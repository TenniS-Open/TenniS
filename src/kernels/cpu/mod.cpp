...
namespace ts {
    namespace cpu {
        ...
        void Mod::reduce_with_broadcast(const Tensor &lhs, const Tensor &rhs, Tensor &out) {
...
#undef DECLARE_COMPUTE_RUN
        ...
        void Mod::reduce_with_scalar(const Tensor &lhs, const Tensor &rhs, Tensor &out) {
            // Notice: the all tensor' memory device are CPU, as given in running_memory_device
            DTYPE dtype = out.dtype();
            switch(dtype) {
#define DECLARE_COMPUTE_RUN(DTYPE, TYPE) \
...
#undef DECLARE_COMPUTE_RUN
        ...
        void Mod::reduce_with_bias(const Tensor &lhs, const Tensor &rhs, Tensor &out, int dim) {
            // Notice: the all tensor' memory device are CPU, as given in running_memory_device
            DTYPE dtype = out.dtype();
            switch(dtype) {
#define DECLARE_COMPUTE_RUN(DTYPE, TYPE) \
...
#undef DECLARE_COMPUTE_RUN
        ...
        void Mod::reduce_with_same_shape(const Tensor &lhs, const Tensor &rhs, Tensor &out) {
            // Notice: the all tensor' memory device are CPU, as given in running_memory_device
            DTYPE dtype = out.dtype();
            switch(dtype) {
#define DECLARE_COMPUTE_RUN(DTYPE, TYPE) \
...
#undef DECLARE_COMPUTE_RUN
        ...
        void Mod::reduce_with_bias_cross(const Tensor &lhs, const Tensor &rhs, Tensor &out, int dim) {
            this->reduce_with_bias(rhs, lhs, out, dim);
        }

        void Mod::reduce_with_scalar_cross(const Tensor &lhs, const Tensor &rhs, Tensor &out) {
...
using namespace ts;
using namespace cpu;
TS_REGISTER_OPERATOR(Mod, CPU, "mod")
