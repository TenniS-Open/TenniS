...
#pragma omp parallel for num_threads(openmp_threads())
                ...
                for (int i = 0; i < count_4; i++){
                    ...
                    *(output_data + ii) = to_int8(*((int32_t*)&(output_int_x4x2.value)));
                    *(output_data + ii + 1) = to_int8(*(((int32_t*)&(output_int_x4x2.value)) + 1));
                    *(output_data + ii + 2) = to_int8(*(((int32_t*)&(output_int_x4x2.value)) + 2));
                    *(output_data + ii + 3) = to_int8(*(((int32_t*)&(output_int_x4x2.value)) + 3));
                    *(output_data + ii + 4) = to_int8(*(((int32_t*)&(output_int_x4x2.value)) + 4));
                    *(output_data + ii + 5) = to_int8(*(((int32_t*)&(output_int_x4x2.value)) + 5));
                    *(output_data + ii + 6) = to_int8(*(((int32_t*)&(output_int_x4x2.value)) + 6));
                    *(output_data + ii + 7) = to_int8(*(((int32_t*)&(output_int_x4x2.value)) + 7));
